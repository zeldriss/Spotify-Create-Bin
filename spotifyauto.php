...
echo "===============================================\n";
echo "  Spotify Auto Create + Auto Gen CC + Checker \n"; 
...
if ($json->status == "20") {
	...
	if ($json->status == 1) {
		...
		echo "[-] Email: $email Pass: $pass Nama: $name=> success \n";
...
echo "[+] Cek Status Valid ? 1/0 : "; $check = trim(fgets(STDIN));
echo "[+] Jumlah : "; $amount = trim(fgets(STDIN));
